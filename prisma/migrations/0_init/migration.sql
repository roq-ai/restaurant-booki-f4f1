...
-- AddForeignKey
ALTER TABLE "reservation" ADD CONSTRAINT "reservation_table_id_fkey" FOREIGN KEY ("table_id") REFERENCES "table_layout"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
